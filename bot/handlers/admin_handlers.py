...
async def __set_bot_mode(msg: Message):
    try:
        ...
        logger.exception('Set bot mode')


@rate_limit(5)
@dp.message_handler(content_types=ContentType.ANY)
async def __no_command(msg: Message):
    try:
